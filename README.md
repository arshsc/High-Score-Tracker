# High Score Tracker
***
<img width="493" height="128" alt="Screenshot 2026-03-06 101020" src="https://github.com/user-attachments/assets/9181d6fa-cb22-47b8-8443-58547b5c37a6" />
...
2. Login if you have an account or sign up if you do not have an account
3. Once in menu, choose between 1. Play Game, 2. View a User, 3. Logout
4. Enter numbers for menu options or 'yes' and 'no' for yes/no prompts
5. Each game provides instructions to play.
...
- Pakistan5681 (Games, Moral support)
